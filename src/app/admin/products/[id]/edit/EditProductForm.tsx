           ...
           <section className="bg-white border border-brand-navy/5 p-8 lg:p-12 space-y-10 shadow-sm relative overflow-hidden">
              ...
              <div className="flex gap-8">
                  <div className="space-y-2 group flex-1">
                     <label className="text-[9px] font-bold uppercase tracking-widest text-brand-text-muted italic">Multiple Colors (Comma separated)</label>
                     <input name="colors_list" defaultValue={colorsList} placeholder="e.g. Gold, Black, Silver" className="w-full bg-brand-background border border-brand-navy/10 px-6 py-4 text-[11px] font-medium tracking-wider outline-none focus:border-secondary transition-all" />
                  </div>
                  <div className="space-y-2 group flex-1">
                     <label className="text-[9px] font-bold uppercase tracking-widest text-brand-text-muted italic">Multiple Sizes (Comma separated)</label>
                     <input name="sizes_list" defaultValue={sizesList} placeholder="e.g. Small, Medium" className="w-full bg-brand-background border border-brand-navy/10 px-6 py-4 text-[11px] font-medium tracking-wider outline-none focus:border-secondary transition-all" />
                  </div>
              </div>
           </section>
        )}
